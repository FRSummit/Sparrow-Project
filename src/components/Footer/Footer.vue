    ...
    <footer>
      <div class="footer-inner">
            ...
            <div class="col-sm-12 col-xs-12 col-lg-8">
              <div class="footer-column pull-left">
                ...
                <ul class="links">
                  ...
                  <li>
                    <a href="#" title="About us">Order History</a>
                  </li>
                  <li>
                    <a href="#" title="faq">FAQ</a>
                  </li>
                  <li>
                    <a href="#" title="Popular Searches">Specials</a>
                  </li>
                  <li class="last">
              ...
              <div class="footer-column pull-left">
                ...
                <ul class="links">
                  ...
                  <li>
                    <a title="Addresses" href="#">Company</a>
                  </li>
                  <li>
                    ...
                    <div id="container_form_news">
                      <div id="container_form_news2">
                        <input
                          ...
                          name="email"
                        />
                        <button class="button subscribe" title="Subscribe" type="submit">
                          <span>Subscribe</span>
                        </button>
                      </div>
                    </div>
        ...
        <div class="container">
          ...
          <address>
            ...
            <span>superb@themesground.com</span>
          </address>
        </div>
      </div>
      ...
      <div class="footer-bottom">
        <div class="container">
          <div class="row">
            <div
              class="col-sm-12 col-xs-12 coppyright"
            >&copy; 2016 ThemesGround. All Rights Reserved.</div>
          </div>
        </div>
      </div>
    </footer>
