<template>
    <section class="main-container col2-right-layout" style="margin-bottom: 20px;">
                    ...
                    <table id="wishlist-table" class="clean-table linearize-table data-table">
                      ...
                      <tbody>
                        <tr id="item_31" class="first odd">
                          <td class="wishlist-cell0 customer-wishlist-item-image"><a title="Softwear Women's Designer" href="#" class="product-image"> <img width="150" height="150" alt="Softwear Women's Designer" src="../../superb-template/products-images/p6.jpg"> </a></td>
                        ...
                        <tr id="item_33" class="odd">
                          <td class="wishlist-cell0 customer-wishlist-item-image"><a title="" href="#" class="product-image"> <img width="150" height="150" alt="Softwear Women's Designer" src="../../superb-template/products-images/p1.jpg"> </a></td>
                        ...
                        <tr id="item_32" class="last even">
                          <td class="wishlist-cell0 customer-wishlist-item-image"><a title="Slim Fit Casual Shirt" href="#" class="product-image"> <img width="150" height="150" alt="Slim Fit Casual Shirt" src="../../superb-template/products-images/p2.jpg"> </a></td>
