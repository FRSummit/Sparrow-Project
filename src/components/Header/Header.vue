              ...
              <div class="col-xs-7 col-sm-6">
                ...
                <div class="dropdown block-currency-wrapper hidden-xs">
                  <a
                    ...
                    data-toggle="dropdown"
                    data-target="#"
                    class="block-currency dropdown-toggle"
                    href="#"
                  >
                    USD
                    <span class="caret"></span>
                ...
                <div class="welcome-msg hidden-xs">Modern Life - Modern Shopping</div>
              </div>
                            ...
                            <div class="item-inner">
                              ...
                              <div class="product-details">
                                ...
                                <p class="product-name">
                                  <a href="#">timi &amp; leslie Sophia Diaper Bag...</a>
                                </p>
                              </div>
                            </div>
                          </li>
                          <li class="item last">
                            <div class="item-inner">
                              ...
                              <div class="product-details">
                                ...
                                <p class="product-name">
                                  <a href="#">JP Lizzy Satchel Designer Diaper Ba...</a>
                                </p>
                              </div>
                            </div>
                          </li>
                ...
                <div class="top-search">
                  <div class="block-icon pull-right">
                    <a
                      ...
                      data-toggle="modal"
                      class="search-focus dropdown-toggle links"
                    >
                      ...
                      <div class="modal-dialog modal-lg">
                        <div class="modal-content">
                          <div class="modal-header">
                            ...
                            >
                              <img
                                src="../../superb-template/images/interstitial-close.png"
                                alt="close"
                              />
                            </button>
                          </div>
