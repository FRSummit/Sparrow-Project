      ...
      <div class="row">
        <div class="col-main col-sm-9">
          ...
          <div class="blog-wrapper latest-blog" id="main">
			...
			<a href="#">
  <span class="author-avatar byline"><img alt="" src="../../superb-template/images/admin-photo.jpg" class="avatar avatar-96 photo">By John Doe</span> <span class="timestamp">January 26, 2016</span>
</a>
</div>
...
<h2>Heading</h2>
<p>Pellentesque volutpat mollis ligula in laoreet. Aenean est dui, sagittis in consequat at, adipiscing at risus. Sed suscipit, est vitae aliquam molestie, sem dolor dignissim leo, eget imperdiet enim urna in justo. Mauris pulvinar tortor lorem. Aliquam sed nisl in ipsum tincidunt ultrices.</p>
<ul>
<li> Aenean est dui, sagittis in consequat</li>
<li> Volutpat mollis ligula in laoreet</li>
<li> Nunc ac sem eu libero pretium faucib. Quisque et semper</li>
<li> Integer vitae diam sed dolor euismod laoreet eget ac felis</li>
<li> Quisque et semper odio. Praesent tortor ligula</li>
</ul>
<h3>Heading</h3>
<p>Pellentesque volutpat mollis ligula in laoreet. Aenean est dui, sagittis in consequat at, adipiscing at risus. Sed suscipit, est vitae aliquam molestie, sem dolor dignissim leo, eget imperdiet enim urna in justo. Mauris pulvinar tortor lorem. Aliquam sed nisl in ipsum tincidunt ultrices.</p>
<h4>Heading</h4>
                      ...
                      <li class="comment">
                        <div class="comment-wrapper" >
                          <div class="comment-author vcard">
                            <p class="gravatar"><a href="#"><img width="60" height="60" alt="avatar" src="../../superb-template/images/avatar60x60.jpg"></a></p>
        ...
        <aside class="col-right sidebar col-sm-3">
          <div role="complementary" class="widget_wrapper13" id="secondary">
            <div class="popular-posts widget widget__sidebar" id="recent-posts-4">
              ...
              <div class="widget-content">
                <ul class="posts-list unstyled clearfix">
                  <li>
                    <figure class="featured-thumb"> <a href="#"> <img width="80" height="53" alt="blog image" src="../../superb-template/images/blog-img1.jpg"> </a> </figure>
                    <!--featured-thumb-->
                    <h4><a title="Pellentesque posuere" href="#">Pellentesque posuere</a></h4>
                    <p class="post-meta"><i class="icon-calendar"></i>
                      <time datetime="2014-07-10T07:09:31+00:00" class="entry-date">Jul 10, 2014</time>
                      .</p>
                  </li>
                  <li>
                    <figure class="featured-thumb"> <a href="#"> <img width="80" height="53" alt="blog image" src="../../superb-template/images/blog-img2.jpg"> </a> </figure>
                    <!--featured-thumb-->
                    <h4><a title="Dolor lorem ipsum" href="#">Dolor lorem ipsum</a></h4>
                    <p class="post-meta"><i class="icon-calendar"></i>
                  ...
                  <li>
                    <figure class="featured-thumb"> <a href="#"> <img width="80" height="53" alt="blog image" src="../../superb-template/images/blog-img1.jpg"> </a> </figure>
                    <!--featured-thumb-->
                    <h4><a title="Aliquam eget sapien placerat" href="#">Aliquam eget sapien placerat</a></h4>
                    <p class="post-meta"><i class="icon-calendar"></i>
                  ...
                  <li>
                    <figure class="featured-thumb"> <a href="#"> <img width="80" height="53" alt="blog image" src="../../superb-template/images/blog-img2.jpg"> </a> </figure>
                    <!--featured-thumb-->
                    <h4><a title="Pellentesque habitant morbi" href="#">Pellentesque habitant morbi</a></h4>
                    <p class="post-meta"><i class="icon-calendar"></i>
            ...
            <div class="popular-posts widget widget_categories" id="categories-2">
              ...
              <ul>
                <li class="cat-item"><a href="#">Category 1</a></li>
                <li class="cat-item"><a href="#">Category 2</a></li>
                <li class="cat-item"><a href="#">Category 3</a></li>
                <li class="cat-item"><a href="#">Category 4</a></li>
                <li class="cat-item"><a href="#">Category 5</a></li>
                
              </ul>
            </div>
            <!-- Banner Ad Block -->
            <div class="ad-spots widget"> <a target="_self" href="#" title=""><img alt="offer banner" src="../../superb-template/images/block3.jpg"></a>
            <br/>
              <a target="_self" href="#" title=""><img alt="offer banner" src="../../superb-template/images/block2.jpg"></a> </div>
            <!-- Banner Text Block -->
