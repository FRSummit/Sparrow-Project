  ...
  <div id="mobile-menu">
    <ul>
      ...
      <li>
        ...
        <ul>
          ...
          <li>
            ...
            <ul>
              <li>
                <a href="checkout_method.html">Checkout Method</a>
              </li>
              <li>
                <a href="checkout_billing_info.html">Checkout Billing Info</a>
              </li>
            </ul>
          </li>
          <li>
          ...
          <li>
            <a href="multiple_addresses.html">Multiple Addresses</a>
          </li>
          <li>
      ...
      <li>
        ...
        <ul>
          <li>
            <a href="#" class>Stylish Bag</a>
            <ul>
              <li>
                <a href="#" class>Clutch Handbags</a>
              </li>
              <li>
                <a href="#l" class>Diaper Bags</a>
              </li>
              <li>
                <a href="#" class>Bags</a>
              </li>
              <li>
                <a href="#" class>Hobo handbags</a>
              </li>
            </ul>
          </li>
          <li>
            <a href="#">Material Bag</a>
            <ul>
              <li>
                <a href="#">Beaded Handbags</a>
              </li>
              <li>
                <a href="#">Fabric Handbags</a>
              </li>
              <li>
                <a href="#">Handbags</a>
              </li>
              <li>
                <a href="#">Leather Handbags</a>
              </li>
            </ul>
          </li>
          <li>
      ...
      <ul>
        <li role="presentation">
          <a role="menuitem" tabindex="-1" href="#">
            <img src="../../superb-template/images/english.png" alt="language" /> English
          </a>
        </li>
        <li role="presentation">
          <a role="menuitem" tabindex="-1" href="#">
            <img src="../../superb-template/images/francais.png" alt="language" /> French
          </a>
        </li>
        <li role="presentation">
          <a role="menuitem" tabindex="-1" href="#">
            <img src="../../superb-template/images/german.png" alt="language" /> German
          </a>
        </li>
      </ul>
    </div>
