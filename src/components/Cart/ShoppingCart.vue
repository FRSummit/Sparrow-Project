<template>
  <section class="main-container col1-layout" style="margin-bottom: 20px;">
                ...
                <table class="data-table cart-table" id="shopping-cart-table">
                  <thead>
                    <tr class="first last">
                      ...
                      <th rowspan="1" class="hidden-phone">
                  ...
                  <tbody>
                    <tr class="first odd">
                      <td class="image">
                        <a class="product-image" title href="#">
                          <img
                            width="75"
                            height="75"
                            alt="Women's Crepe Printed Black"
                      ...
                      <td>
                        <h2 class="product-name">
                          <a
                            href="#"
                          >World Traveler Black and White Polka Dots X-Large Tote Bag 19-inch</a>
                        </h2>
                      </td>
                      ...
                      <td class="a-center hidden-table">
                        <a class="link-wishlist1 use-ajax" href="#">Move</a>
                      </td>
                      <td class="a-center hidden-table">
                    ...
                    <tr class="last even">
                      ...
                      <td>
                        <h2 class="product-name">
                          <a href="#">Stylish Girl- Fashion Closet and Style Shopping</a>
                        </h2>
                      </td>
                      <td class="a-center hidden-table">
                        <a title="Edit item parameters" class="edit-bnt" href="#"></a>
                ...
                <div class="shipping-form">
                  <form id="shipping-zip-form" method="post" action="#">
                    ...
                    <div class="buttons-set11">
                      <button class="button get-quote" title="Get a Quote" type="button">
                  ...
                  <ul class="checkout">
                    ...
                    <li>
                      <a
                        ...
                        href="#"
                      >Checkout with Multiple Addresses</a>
                    </li>
                    <br />
                  </ul>
                </div>
