              ...
              <div id="checkout-step-billing" class="step a-item">
                <form id="co-billing-form" action>
                  <fieldset class="group-select">
                    ...
                    <button type="button" class="button continue" onclick="#">
                      <span>Continue</span>
                    </button>
                  </fieldset>
                </form>
                ...
                <form action id="co-shipping-form">
                  <fieldset class="group-select">
                    ...
                    <div class="buttons-set1" id="shipping-buttons-container">
                      <button type="button" class="button continue" onclick="shipping.save()">
                        <span>Continue</span>
                      </button>
                      <a href="#" onclick="checkout.back(); return false;" class="back-link">« Back</a>
                    </div>
                  </fieldset>
                </form>
              </div>
                ...
                <form id="co-shipping-method-form" action>
                  <fieldset>
                    ...
                    <div class="buttons-set1" id="shipping-method-buttons-container">
                      <button type="button" class="button continue" onclick="shippingMethod.save()">
                        <span>Continue</span>
                      </button>
                      <a href="#" onclick="checkout.back(); return false;" class="back-link">« Back</a>
                    </div>
            ...
            <div class="block-content">
              <dl>
                ...
                <dd class="complete">
                  <address>
                    John Deo
                    <br />Better Technology Labs.
                    <br />23 North Main Stree
                    <br />Windsor
